...
TaskHandle_t ntTimerTaskHandler;
...
void openAppDateTime(){
    ...
    ui_dateTimeswAuto = create_switch(ui_dateTimeScreen, 100 , ui_dateTimeScreen_event);
    ...
    ui_dateTimesw24 = create_switch(ui_dateTimeScreen, 350, ui_dateTimeScreen_event);
...
//       "timerTask", // Name of the task (for debugging)
